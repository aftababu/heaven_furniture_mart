      ...
      <div className="max-w-[1600px] mx-auto px-4 xs:px-6 sm:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-13 gap-6 sm:gap-10 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col">
            ...
            <div className="flex flex-col gap-5 sm:gap-6 mb-8 sm:mb-12">
              <div className="flex gap-4 sm:gap-5 items-start">
                <div className="w-10 sm:w-12 h-10 sm:h-12 rounded-lg bg-accent text-primary-bg flex items-center justify-center flex-shrink-0 shadow-md">
              ...
              <div className="flex gap-4 sm:gap-5 items-start">
                <div className="w-10 sm:w-12 h-10 sm:h-12 rounded-lg border border-border flex items-center justify-center flex-shrink-0 bg-primary-bg/60">
          ...
          <div className="lg:col-span-7 flex flex-col">
            <div className="relative rounded-2xl overflow-hidden shadow-xl bg-primary-bg p-1 border border-border">
              <div
                ref={containerRef}
                ...
                className="relative w-full aspect-[4/3] xs:aspect-[16/10] sm:aspect-[16/12] overflow-hidden rounded-xl cursor-ew-resize select-none"
              >
                ...
                >
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-9 xs:w-10 sm:w-12 h-9 xs:h-10 sm:h-12 rounded-full bg-text border-2 border-primary-bg flex items-center justify-center shadow-2xl">
                    <Sliders className="w-4 sm:w-5 h-4 sm:h-5 text-primary-bg" />
                  </div>
                </div>

                {/* 4. Labels */}
                <div className="absolute top-3 xs:top-4 left-3 xs:left-4 bg-primary-bg/90 backdrop-blur-md px-2.5 xs:px-3 py-1 rounded-sm z-30 shadow-sm border border-border pointer-events-none">
                  <span className="font-hanken text-[0.65rem] xs:text-[0.7rem] text-text tracking-widest font-bold uppercase">
                    {t("labelBefore")}
                  </span>
                </div>
                <div className="absolute top-3 xs:top-4 right-3 xs:right-4 bg-text/90 backdrop-blur-md px-2.5 xs:px-3 py-1 rounded-sm z-30 shadow-sm border border-primary-bg/20 pointer-events-none">
