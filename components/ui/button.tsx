...
const buttonVariants = cva(
  "inline-flex items-center justify-center font-hanken uppercase tracking-[0.16em] font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent disabled:pointer-events-none disabled:opacity-50 select-none cursor-pointer rounded-none",
  {
    variants: {
      variant: {
        default:
        ...
        gradient:
          "heaven-button bg-accent text-primary-bg hover:animate-none hover:text-primary-bg shadow-sm rounded-none",
        textGradient:
          "bg-clip-text text-transparent bg-linear-to-b from-accent to-text/70 hover:text-accent shadow-none rounded-none",
